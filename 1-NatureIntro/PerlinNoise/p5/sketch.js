...
function Tracer(){
  ...
  this.update = function(){
    ...
    // keep inside canvas
    if(this.pos.x < 0 || this.pos.x > width){ this.vel.x = this.vel.x * -0.5; }
    if(this.pos.y < 0 || this.pos.y > height){ this.vel.y = this.vel.y * -0.5; }
  };
...
function Target(){
  ...
  this.update = function(){
    // create a random direction for acceleration
